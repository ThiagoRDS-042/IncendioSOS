 ...
 * @author GGrio
 */
public class ConfigsAdm extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfigsAdm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
